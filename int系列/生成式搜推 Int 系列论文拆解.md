...
- [Customized mask 的实现展开](#customized-mask-的实现展开)
  - [Causal mask：控制时间方向](#causal-mask控制时间方向)
  - [Session-wise mask：控制 session/action 边界](#session-wise-mask控制-sessionaction-边界)
  - [Invalid-Q mask：控制无效 Q placeholder](#invalid-q-mask控制无效-q-placeholder)
  - [三类 mask 的最终规则](#三类-mask-的最终规则)
  - [一个极简例子](#一个极简例子)
- [DSFNet](#dsfnet)
- [Temporal candidate alignment](#temporal-candidate-alignment)
- [TIP: Task-Guided Information Persistence](#tip-task-guided-information-persistence)
- [TSG: Task-Specific Selective Gating](#tsg-task-specific-selective-gating)
- [TSF: Task-Aware Scenario Factorization](#tsf-task-aware-scenario-factorization)
- [TIP、TSG、TSF 的关系](#tiptsgtsf-的关系)
- [问题一：目标错位](#问题一目标错位)
- [问题二：序列过长](#问题二序列过长)
...
- [# 1.5 模型结构](#15-模型结构)
  ...
  - [# DSFNet](#dsfnet)
  - [# Temporal candidate alignment](#temporal-candidate-alignment)
- [# 1.6 实验和线上结果](#16-实验和线上结果)
- [# 1.7 论文价值](#17-论文价值)
- [# 1.8 局限和谨慎点](#18-局限和谨慎点)
- [# 1.9 总结](#19-总结)
- [# 2.1 一句话总结](#21-一句话总结)
- [# 2.2 论文要解决什么问题](#22-论文要解决什么问题)
- [# 2.3 核心贡献](#23-核心贡献)
- [# 2.4 输入和多任务表示](#24-输入和多任务表示)
- [# 2.5 模型结构](#25-模型结构)
  - [# TIP: Task-Guided Information Persistence](#tip-task-guided-information-persistence)
  - [# TSG: Task-Specific Selective Gating](#tsg-task-specific-selective-gating)
  - [# TSF: Task-Aware Scenario Factorization](#tsf-task-aware-scenario-factorization)
  - [# TIP、TSG、TSF 的关系](#tiptsgtsf-的关系)
- [# 2.6 实验和线上结果](#26-实验和线上结果)
- [# 2.7 论文价值](#27-论文价值)
- [# 2.8 局限和谨慎点](#28-局限和谨慎点)
- [# 2.9 总结](#29-总结)
- [# 3.1 一句话总结](#31-一句话总结)
- [# 3.2 论文要解决什么问题](#32-论文要解决什么问题)
  - [# 问题一：目标错位](#问题一目标错位)
  - [# 问题二：序列过长](#问题二序列过长)
- [# 3.3 核心思想](#33-核心思想)
- [# 3.4 SID Redistribution](#34-sid-redistribution)
- [# 3.5 Length Reduction](#35-length-reduction)
- [# 3.6 模型结构怎么理解](#36-模型结构怎么理解)
- [# 3.7 实验和结果](#37-实验和结果)
- [# 3.8 论文价值](#38-论文价值)
- [# 3.9 局限和谨慎点](#39-局限和谨慎点)
- [# 3.10 总结](#310-总结)
- [# 4.1 从任务统一到业务统一](#41-从任务统一到业务统一)
- [# 4.2 从外部统一到内部统一](#42-从外部统一到内部统一)
- [# 4.3 共同的工业取向](#43-共同的工业取向)
- [# 第 1 篇](#第-1-篇)
- [# 第 2 篇](#第-2-篇)
- [# 第 3 篇](#第-3-篇)
